...
import 'package:google_maps/models/bus_seat_model.dart';
...
class _BookingBusSeatScreenState extends State<BookingBusSeatScreen> {
  List<BusSeatModel> seats = List.generate(18, (index) {
    return BusSeatModel(index + 1, 20.0, false);
  });
  ...
  void _toggleSeatSelection(BusSeatModel seat) {
    setState(() {
  ...
  Widget _SeatLayout(BusSeatModel seat) {
