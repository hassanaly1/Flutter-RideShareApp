...
import 'package:google_maps/models/car_seat_model.dart';
...
class _BookingCarSeatScreenState extends State<BookingCarSeatScreen> {
  List<CarSeatModel> seats = List.generate(
  ...
  void _toggleSeatSelection(CarSeatModel seat) {
  ...
  Widget _SeatLayout(CarSeatModel seat) {
