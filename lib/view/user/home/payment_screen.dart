...
import 'package:google_maps/models/payment_model.dart';
import 'package:google_maps/view/user/home/checkout_screen.dart';
            ...
            CustomButton(
              ...
              onTap: () {
                PaymentModel(
                    ...
                    cardExpiration: int.parse(cardExpirationController.text),
                    cardSecurityCode:
                        int.parse(cardSecurityCodeController.text));
